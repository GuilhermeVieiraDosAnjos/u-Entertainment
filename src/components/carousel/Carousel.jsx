...
//       const newSlidesToShow = screenWitdh < 1060 ? 1 : 3
//       setIsmobile(newSlidesToShow);
//     }
...
//         </Slider>
//       </div>
//       <div className={`md:absolute md:top-1/2 md:transform md:-translate-y-1/2 left-0 ${window.innerWidth < 1060 ? 'hidden' : ''}`}> 
//         <button onClick={goToPrevious} disabled={currentSlide === 0} className='bg-gray-800 rounded-full p-2 text-white ml-10'>
//           <IoIosArrowBack  />
//         </button>
//       </div>
//         <div className={`md:absolute md:top-1/2 md:transform md:-translate-y-1/2 right-0 ${window.innerWidth < 1060 ? 'hidden' : ''}`}>
